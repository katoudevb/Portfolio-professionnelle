...
const projets: Projet[] = [
  ...
  { id: 10, title: "Créer la plateforme hébergée 'Trouve ton Artisan' avec Angular", img: ArtisanImage, desc: "Création d'une plateforme en ligne pour faciliter la mise en relation entre particuliers et artisans", github: "https://github.com/katoudevb/TrouveTonArtisan", date: "30 Juin 2025", category: "Ecole" },
